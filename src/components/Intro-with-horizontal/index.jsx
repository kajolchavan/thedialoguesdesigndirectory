                    ...
                    <div className="row">
                      <div className="col-lg-8 col-md-10">
                        <div className="caption hmone mt-100">
                          <h5 className="thin regularSubTitle">{slide.title.first}</h5>
                          <Split>
                            <h1
                              data-splitting
                              className="words chars boldSubTitle splitting"
                            >
                              <Link href="#">{slide.title.second}</Link>
                            </h1>
                          </Split>
                          {slide?.content && (
                            <p className="mt-10 regularSubTitle">
                              {slide.content.first} <br />
                              {slide.content.second}
                            </p>
                          )}
                          <Link href="/about">
                            <a className="btn-curve boldSubTitle btn-bord btn-lit mt-30">
                              <span>Read More</span>
                            </a>
                          </Link>
                        </div>
